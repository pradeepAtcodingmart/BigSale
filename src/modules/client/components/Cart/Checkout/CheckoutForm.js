    ...
    if (field === 'state') {
      ...
      var district =
        event.target.value === 'karnataka'
          ? karnataka
          : event.target.value === 'tamilnadu'
            ? tamilnadu
            : andra;
      this.setState({ district: district });
    } else customerDetails[field] = event.target.value;
    if (field === 'payment') {
      this.setState({
        radioCheck: true,
        isCod: false,
      ...
      if (event.target.value === 'cod') this.setState({ isCod: true });
      if (event.target.value === 'card') this.setState({ iscard: true });
          ...
          >
            <form noValidate autoComplete="off">
              ...
              <FormControl>
                ...
                {this.state.radioCheck ? null : (
                  <p style={{ color: 'red' }}>Choose Payment Type</p>
                )}
                <RadioGroup
                  aria-label="Payment"
                  name="payment"
                  ...
                  {this.state.iscard ? (
                    <span>
                      <TextValidator
                        ...
                        validators={[
                          `${this.state.iscard ? 'required' : null}`,
                        ]}
                      />
                    </span>
                  ) : null}
                  ...
                  {this.state.isNetBank ? (
                    <span>
                      <TextValidator
                        ...
                        validators={[
                          `${this.state.isNetBank ? 'required' : null}`,
                        ]}
                      />
                      <TextValidator
                        type="password"

        ...
        {products && (
          <Paper>
            <Table className={classes.table}>
              <TableHead>
                <TableRow>
                  <CustomTableCell>Restarunt Name</CustomTableCell>
                    ...
                    products[key].map((product, index) => {
                      return (
                        <TableRow className={classes.product} key={index}>
                          ...
                          <CustomTableCell className={classes.cell} numeric>
                            {product.category}
                          </CustomTableCell>
                          ...
                          <CustomTableCell className={classes.cell}>
                            {' '}
                            <Link to={`/form/${product.category}/${index}`}>
                              {button}
                            </Link>
                          </CustomTableCell>
                          <CustomTableCell className={classes.cell}>
                            <Icon
                              ...
                              onClick={() =>
                                this.handlDelete(index, product.category)
                              }
                            >
                              delete
                            </Icon>

        ...
        return (
            <div>
                ...
                <div className={classes.container}>
                            ...
                            Name: {this.state.customer.customerDetails.name}<br />
                            MailId: {this.state.customer.customerDetails.emailId}<br />
                            Phone Number: {this.state.customer.customerDetails.phoneNumber}<br />
                           ...
                           {this.state.customer.customerDetails.state}<br />
                           <hr/>
                           ...
                           <table cellSpacing="10">
                               ...
                               {this.state.cart.cloth.map((data,index)=>(
                                   <tr>
                                       <td>
                               ...
                               {this.state.cart.watchs.map((data,index)=>(
                                   <tr>
                                       <td>
                                           {data.name}({data.quantity})
                                       </td>
                               ...
                               {this.state.cart.shoes.map((data,index)=>(
                                   <tr>
                                       <td>
                                           {data.name}({data.quantity})
                                       </td>
                               ...
                               <tr>
                                   <td></td>
                                   <td>Sub total:&#8377;{this.state.customer.totalPrice.allTotal}</td>
                              </tr>
                              <tr>
                                   <td></td>
                                   <td>Total:&#8377;{this.state.customer.totalPrice.allTotal}</td>
                            </tr>
                           </table>
